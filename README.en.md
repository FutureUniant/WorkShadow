...
You can also install the **[development build](https://github.com/FutureUniant/WorkShadow/releases/download/v0.1.1/WorkShadow_0.1.1_x64-dev-setup.exe)** (`WorkShadow_0.1.1_x64-dev-setup.exe`) without setting up the dev environment below.
